  ...
  apiData
    ...
    .forEach((obj) => {
      DOMSelectors.box.insertAdjacentHTML(
        "beforeend",
        `
      <div class="card w-1/5 sm:w-3/5 md:w-2/5 lg:w-1/5 h-auto  bg-[#150709] rounded-3xl flex flex-col items-center justify-around m-8 border-2 border-[#e0d1ad] font-hylia">
